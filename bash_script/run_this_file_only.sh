...
wget https://netphim.site/bash_script/example.conf
...
composer require hacoidev/ophim-crawler hacoidev/ophim-ripple
rm -r .git

wget https://netphim.site/bash_script/CoreProvider.txt
mv CoreProvider.txt CoreProvider.php
